...
p = Dict([
	...
	:aC1 => 0.0375,   # A:A association (binding) rate - 37A-B
	:aC2 => 0.0375,   # A:A association (binding) rate - 154A-B
	:dC1 => 0.0375,   # D:D association (binding) rate - 37A-B
	:dC2 => 0.0375,   # D:D association (binding) rate - 154A-B
	...
	:aP => NaN,       # BY RULE: A:A association (binding) rate (e.g. [0.0012,2000] 1/nM 1/min)
	:dP => NaN,       # BY RULE: D:D association (binding) rate (e.g. [0.0012,2000] 1/nM 1/min)
]);
