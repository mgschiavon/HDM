mrw  = (pOp  = [:bP],# Parameters to optimize
		pMin = [-5],# Minimum parameter value to explore (log10)
		pMax = [5],# Maximum parameter value to explore (log10)
		runs = 4,	# Number of optimization runs
		iter = 20000,# Number of iterations per optimization run
		cov  = [0.1],# Covariance to calculate parameter random walk
