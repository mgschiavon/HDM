mrw  = (pOp  = [:eC1,:eC2,:eC3,:eC4,:eC5,:eC6],# Parameters to optimize
		pMin = [-5,-5,-5,-5,-5,-5],# Minimum parameter value to explore (log10)
		pMax = [1,1,1,1,1,1],# Maximum parameter value to explore (log10)
