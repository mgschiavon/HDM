mrw  = (pOp  = [:bP,:eC1,:eC2,:eC3],# Parameters to optimize
		pMin = [-5,-5,-5,-5],# Minimum parameter value to explore (log10)
		pMax = [5,5,5,5],# Maximum parameter value to explore (log10)
...
d = (Hi = x[1,2:end],		# Hormone (Pg) concentrations tested
	 ...
	 Xe = x[2:end,5:end]);	# YFP steady state measurements
