mrw  = (pOp  = [:eC1,:eC2,:eC3,:kY,:nY],# Parameters to optimize
		pMin = [-5,-5,-5,-3,-1],# Minimum parameter value to explore (log10)
		pMax = [1,1,1,3,2],# Maximum parameter value to explore (log10)
		runs = 4,	# Number of optimization runs
		iter = 20000,# Number of iterations per optimization run
		cov  = [0.1,0.1,0.1,0.1,0.05],# Covariance to calculate parameter random walk
