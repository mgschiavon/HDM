...
p = Dict([
	...
	:mY => 0.031082,  # Y maximum synthesis rate (nM/min)
	:aY => 0.0083109,      # Basal activity
	:nY => 1,       # Hill function
	:kY => 0.44641,   # Dissociation constant\
	:eM => 0.01,      # A:D dissociation (unbinding) rate (e.g. [0.05,140] 1/min)
	:eC1 => 0.039196, # A:D association (binding) rate - 37A-B
	:eC2 => 548.625,  # A:D association (binding) rate - 154A-B
