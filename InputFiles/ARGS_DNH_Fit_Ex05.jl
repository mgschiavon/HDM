mrw  = (pOp  = [:eC1,:eC2,:eC3,:bP,:kY],# Parameters to optimize
		pMin = [-5,-5,-5,-3,-3],# Minimum parameter value to explore (log10)
		pMax = [1,1,1,3,3],# Maximum parameter value to explore (log10)
