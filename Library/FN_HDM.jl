...
module fn
	...
	#        uns  - 1 to use a slower, more stable ODE solver
	# OUPUT: DYs   - Vector of DY values for the range of perturbation
	...
	# DY "metrics"
	# INPUT: DYs   - Vector of DY values for the range of perturbation
	#        pert  - Handle for the perturbation details
	...
	#        pert  - Handle for the perturbation details
	#        motif - Handle for the considered motif
	#        DYs   - Vector of DY values for the range of perturbation
	#        uns  - 1 to use a slower, more stable ODE solver
